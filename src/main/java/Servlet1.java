...
//		out.println("<h1>Details of Volunteers</h1>");
		...
		out.print("<table border = '4'><tr><th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl\">Name</th><th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl\">City</th><th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl\">Contact</th><th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl\">Animals</th></tr>");
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select*from pet where pin="+pin+"");
